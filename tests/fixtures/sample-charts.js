...
const sampleNatalChart = {
  planets: {
    ...
    venus: { lon: 110.2, lat: 1.5, retrograde: false },
    mars: { lon: 45.3, lat: -0.8, retrograde: true },
    jupiter: { lon: 200.15, lat: 0.5, retrograde: false },
    saturn: { lon: 290.45, lat: 2.1, retrograde: false },
    uranus: { lon: 15.6, lat: -0.3, retrograde: false },
    neptune: { lon: 325.8, lat: 1.2, retrograde: false },
...
const sampleTransitChart = {
  ...
  transit: {
    planets: {
      sun: { lon: 290.15, lat: 0.0, retrograde: false },
      moon: { lon: 45.67, lat: 4.8, retrograde: false },
      mercury: { lon: 275.3, lat: -1.5, retrograde: true },
      venus: { lon: 310.45, lat: 2.1, retrograde: false },
      mars: { lon: 180.2, lat: -1.2, retrograde: false },
      jupiter: { lon: 65.8, lat: 0.8, retrograde: true },
      saturn: { lon: 350.9, lat: 2.5, retrograde: false },
      uranus: { lon: 25.4, lat: -0.5, retrograde: false },
      neptune: { lon: 330.1, lat: 1.0, retrograde: false },
      pluto: { lon: 275.6, lat: 16.2, retrograde: false },
    },
