...
if [ "$ACTIVE_SLOT" = "blue" ]; then
    PREVIOUS_SLOT="green"
    PREVIOUS_PORT=3012
    PREVIOUS_UPSTREAM="nocturna-chart-green:3011"
else
    PREVIOUS_SLOT="blue"
    PREVIOUS_PORT=3014
    PREVIOUS_UPSTREAM="nocturna-chart-blue:3011"
fi
...
sed -i.bak "s|server [^;]*;  # Default:.*|server ${PREVIOUS_UPSTREAM};  # Default: ${PREVIOUS_SLOT}|" nginx.conf
